  ...
  return (
    <div className='relative'>
      <div className='flex flex-row items-center gap-3'>
        ...
        hover:bg-neutral-100 transition cursor-pointer'>Airbnb your home</div>
      ...
      {isOpen && (
        <div className="absolute rounded-xl shadow-sm w-[40vw] md:w-3/4 bg-white overflow-hidden 
